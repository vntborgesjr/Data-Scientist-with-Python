...
# there is no data to run this example...
...
# there is no data to run the code...
...
# Using merge_asof()  -------------------------------------------
######################################################################
# Using merge_asof() to study stokcs
# there is no data to run the examples...
...
price_diffs.plot(y=['close_jpm', 'close_wells', 'closebac'])
plt.show()
