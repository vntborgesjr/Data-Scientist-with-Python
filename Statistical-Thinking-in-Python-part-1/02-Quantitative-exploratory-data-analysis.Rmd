---
title: "02 - Quantitative exploratory data analysis"
output: 
  html_notebook:
    toc: true
    toc_float: false
...
The covariace is the mean of the product of the difference between observations and their respective means.
The Pearson correlation coefficient is a dimensionless measure of how two variables depend on each other. We divide the covariance by the product of the standard deviation of x and y variables.
It is the comparison of the variability in the data due to  codependence (the covariance) to the variability inherent to  each variable indpendently (their standard deviations).
