...
climate_change = pd.read_csv('/Users/clari/Documents/Vitor/DataCamp/Data-Scientist-with-Python/Datasets/climate_change.csv', parse_dates = True, index_col = 'date')
```
...
_ = ax.plot(climate_change.index, climate_change.relative_temp)

# Set the x-axis label
_ = ax.set_xlabel('Time')

# Set the y-axis label
_ = ax.set_ylabel('Relative temperature (Celsius)')
...
_ = ax.plot(seventies.index, seventies["co2"])
...
_ = ax.plot(climate_change.index, climate_change.co2, color = 'blue')

# Create a twin Axes that shares the x-axis
ax2 = ax.twinx()

# Plot the relative temperature in red
_ = ax2.plot(climate_change.index, climate_change.relative_temp, color = 'red')
...
_ = plot_timeseries(ax, climate_change.index, climate_change['co2'], "blue", 'Time (years)', 'CO2 levels')

# Create a twin Axes object that shares the x-axis
ax2 = ax.twinx()

# Plot the relative temperature data in red
_ = plot_timeseries(ax2, climate_change.index, climate_change['relative_temp'], "red", 'Time (years)', 'Relative temperature (Celsius)')
...
_ = ax.annotate('>1 degree', (pd.Timestamp('2015-10-06'), 1))
...
# Plot the relative temperature data in red
_ = plot_timeseries(ax2, climate_change.index, climate_change['relative_temp'], 'red', 'Time (years)', 'Relative temp (Celsius)')

# Annotate point with relative temperature >1 degree
_ = ax2.annotate(">1 degree", xy = ( pd.Timestamp('2015-10-06'), 1), xytext = (pd.Timestamp('2008-10-06'), -0.2), arrowprops = {'arrowstyle': '->', 'color': 'gray'})
