---
title: "A Visual History of the Nobel Prize Winners"
...
nobel['female_winner'] = nobel.sex.isin(['Female'])
...
nobel[nobel['sex'] == 'Female'].nsmallest(n = 1, columns = 'female_winner')
```
...
display(nobel.groupby(by = 'full_name').filter(lambda x: len(x) >= 2))
```
...
_ = sns.lmplot(data = nobel, x = 'year', y = 'age')
```
...
_ = sns.lmplot(data = nobel, x = 'year', y = 'age', row = 'category')
```
